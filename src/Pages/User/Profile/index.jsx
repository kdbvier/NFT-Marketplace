            ...
            <div className="flex">
              ...
              <div className="pl-[20px]">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-[13px] text-txtblack">{user.area}</span>
                </div>
                <div className="flex items-center">
                  <i className="fa-solid fa-briefcase mr-[7px] text-danger-1 text-[12px]"></i>
                  <span className="text-[13px] text-txtblack">{user.job}</span>
                </div>
              </div>
            </div>
                          ...
                          {royaltiesList.map((r, index) => (
                            ...
                            >
                              ...
                              <td className="py-4 px-5 font-black ">
                                <Link
                                  to={`/project-details/${r.project_id}`}
                              ...
                              <td className="py-4 px-5 font-black ">
                                <Link
                                  to={`/collection-details/${r.collection_id}`}
                                  className="!no-underline"
                                >
                                  {r.collection_name}
                                </Link>
