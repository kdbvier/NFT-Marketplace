...
function Home() {
  ...
  return (
    <div className="text-txtblack dark:text-white pt-12">
      ...
      <section className="grid md:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl  min-h-[390px]">
          <a href="#" >
            <img className="rounded-t-xl h-36 object-cover w-full" src={thumbIcon} alt="" />
          </a>

          <div className="p-5 relative text-center">
            <div className="h-14 w-full" >
              <img className="rounded-full w-28 h-28 absolute -top-14 left-1/2 z-10 -ml-14 " src={avatar} alt="" />
            </div>
            <h2 className="mb-2 text-txtblack truncate">BoredApeYatchClub</h2>
            <p className="mb-3 text-textSubtle text-[13px]">Value : 1.000.000 USD</p>

            <div className="flex justify-center items-center">
              <img className="rounded-full w-9 h-9 -ml-1 " src={avatar} alt="" />
              <img className="rounded-full w-9 h-9 -ml-1 " src={avatar} alt="" />
              <img className="rounded-full w-9 h-9 -ml-1 " src={avatar} alt="" />
              <img className="rounded-full w-9 h-9 -ml-1 " src={avatar} alt="" />
              <img className="rounded-full w-9 h-9 -ml-1 " src={avatar} alt="" />
        ...
        <div className="bg-white rounded-xl min-h-[390px]">
          <a href="#" >
            <img className="rounded-t-lg h-36 object-cover w-full" src={thumbIcon} alt="" />
          </a>
      ...
      <section className="mb-5">
        ...
        <div className="flex justify-center space-x-1">
          ...
          <a href="#" className="px-3 py-1 font-satoshi-bold text-sm text-primary-900 bg-primary-900 bg-opacity-5 rounded hover:bg-opacity-7">
            1
          </a>
          <a href="#" className="px-3 py-1 font-satoshi-bold text-sm text-primary-900 bg-primary-900 bg-opacity-5 rounded hover:bg-opacity-7">
            2
      ...
      <section className="grid md:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
        ...
        <div className="min-h-[390px] rounded-x">
          <a href="#" >
            <img className="rounded-xl h-[276px] object-cover w-full" src={thumbIcon} alt="" />
          </a>

          <div className="p-5">
            <h2 className="mb-2 text-txtblack truncate">NFT Collection #1</h2>
            <p className="mb-3 text-textSubtle text-[13px]">There are many variations of passages of Lorem</p>
