      ...
      <main className="container mx-auto px-4">
        ...
        <section className="flex flex-col md:flex-row pt-5 md:pt-14">
          <div className="md:w-2/3 text-white">
            <div className="flex">
              <img
                className="rounded-lg self-start w-14 h-14 md:w-[98px] md:h-[98px] bg-color-ass-6"
                src=""
                width={98}
              ...
              <div className="flex-1 min-w-0  px-4">
                <h1 className="-mt-1 mb-1 md:mb-2 text-ellipsis overflow-hidden whitespace-nowrap">
                  Muhammad Rifat Abubakar Abubakar
                </h1>
                <p className="flex">
                  <svg
                    className="mt-1 mr-1"
          ...
          <div className="flex flex-wrap mt-3 md:justify-end md:w-1/3  md:mt-0" role="group">
        ...
        <section className="flex justify-center pt-4 md:pt-10">
          <div className="inline-flex py-4 text-white text-center">
            <div className="border-r border-color-ass px-5 last:border-0">
              <strong className="display-block font-black font-satoshi-bold text-[22px]">0</strong>
              <span>Views</span>
            </div>

            <div className="border-r border-color-ass px-5 last:border-0">
              <strong class="display-block font-black font-satoshi-bold text-[22px]">0</strong>
              <span>Followers</span>
            </div>
        ...
        <section className="text-center py-6">
          <img className="inline-block mb-4 md:mb-7" src={noProject} alt="This user haven’t create any Project." />
          <div className="text-color-ass-2 font-bold text-lg md:text-[26px]">This user haven’t create any Project.</div>
        </section>


        <section className="text-center py-6">
          <img className="inline-block mb-4 md:mb-7" src={emptyProject} alt="This user haven’t create any Project." />
          <div className="text-color-ass-2 font-bold text-lg md:text-[26px]">You Doesnt have any Project.<br /> let’s go create new project!</div>
          <button type="button" class="btn-outline-primary-gradient btn-md mt-5"><span>Create New <i class="fa-thin fa-square-plus ml-2"></i></span></button>
        </section>
