    ...
    <div>
      ...
      >
        ...
        <div className="sidebarLinksContainer flex flex-col">
          ...
          <a href="#" className="flex content-center font-satoshi-bold mb-2 px-7 py-4 font-bold text-primary-color-5  ease-in-out duration-300 hover:text-white rounded  active:bg-primary-color-5 text-white last:mt-auto">
