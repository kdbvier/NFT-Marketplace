...
export default function CollectionCard({ collection }) {
  ...
  return (
    <div className="min-h-[390px]  w-[156px]  md:w-[276px] rounded-x">
      <Link
        to={
      ...
      >
        <img
          className="w-[156px] md:w-[276px] rounded-xl h-[276px] object-cover"
          src={
      ...
      <div className="p-5">
        ...
        <div className="flex items-center">
          {collection.members &&
            ...
            truncateArray(collection.members).slicedItems.map((member) => (
              <img
                src={member.avatar}
                alt={member.id}
