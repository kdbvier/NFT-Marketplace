          ...
          <div className="flex flex-wrap items-center">
            ...
            <form className="search lg:ml-20 ml-5">
              ...
              <div className="relative">
                ...
                <input type="search" id="default-search" className="search-fld font-satoshi-regular text-lg max-w-full text-white rounded-xl pl-10 h-10" placeholder="Search your project by name" required />
              </div>
            </form>
